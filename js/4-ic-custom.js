  ...
  controller: function ($scope) {
    this.$onInit = function () {
      setTimeout(function () {
        ...
        var searchScopes = document.querySelectorAll(
          'div.simple-search-wrapper [id^="select_option_"]'
        );
...
app.controller("ebscoLinkController", [
    ...
    this.$onInit = function () {
      {
        ...
        const googleBaseUrl =
          "https://scholar.google.com/scholar?hl=en&as_sdt=0%2C33&inst=7210957415625843320&q=";
        this.googleProxiedSearchUrl = googleBaseUrl + googleSearchString;

        this.worldCatLabel = "WorldCat";
        const worldCatBaseUrl =
          "https://www.worldcat.org/search?qt=worldcat_org_all&q=";
        this.worldCatProxiedSearchUrl =
          proxyString + worldCatBaseUrl + worldCatSearchString;
      }
    };
  },
]);
    ...
    this.$onInit = function () {
      {
        ...
        try {
          this.physical = Boolean(
            this.parentCtrl.item.delivery.GetIt1[0].category === "Alma-P" ||
              this.parentCtrl.item.delivery.GetIt1[1].category === "Alma-P"
          );
        } catch (e) {
          this.physical = false;
        }
        ...
        try {
          var theCallNumber =
            this.parentCtrl.item.delivery.bestlocation.callNumber;
        ...
        try {
          this.location =
            this.parentCtrl.item.delivery.bestlocation.subLocationCode;
        ...
        try {
          this.availability =
            this.parentCtrl.item.delivery.bestlocation.availabilityStatus;
        } catch (e) {
          this.availability = "";
          this.mapError = true;
        }
        ...
        this.needsMap = Boolean(
          (((this.availability === "available" &&
            this.location !== "reserves") ||
            this.availability === "check_holdings") &&
            this.callNumber &&
            this.physical) ||
            this.location === "periodical"
        );
        ...
        if (this.needsMap) {
          ...
          if (!this.staticLocation) {
            ...
            for (let i = 0; i < this.lookupArray.length; i++) {
              ...
              if (
                this.normalizeLC(test[1]) ===
                  this.normalizeLC(this.callNumber) ||
                test.length === 2
              ) {
            ...
            if (this.coordinates) {
              ...
              this.locMessage =
                "This item is available at stack " +
                this.stack +
                ", " +
                this.sideLong +
                " side.";
    ...
    this.$onInit = function () {
      {
        ...
        try {
          ...
          let addataString = "";
          this.reportFormUrl =
            "https://library.ithaca.edu/forms/primo_problems.php?origin=primo&";
...
app.component("prmGalleryCollectionsListAfter", {
  template:
    '<p>For more information about our digital collections, see our <a href="https://libguides.ithaca.edu/digital_library">Digital Collections Guide</a> or contact <a href="mailto:digitalcollections@ithaca.edu">digitalcollections@ithaca.edu</a>. For information on submitting materials to the collection, see our <a href="https://library.ithaca.edu/policies/digitalcollections.php">Digital Collections Content Submission Policies and Guidelines</a>.</p>',
});
...
(function () {
  ...
  lc.src =
    ...
    "v2.libanswers.com/load_chat.php?hash=88261efafc9e5e717508101165503bda";
